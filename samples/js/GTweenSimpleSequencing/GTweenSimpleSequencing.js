...
var GTweenSimpleSequencing = function() {
	...
	this.ball.style.marginLeft = "-" + radius + "px";
	this.ball.style.marginTop = "-" + radius + "px";
	this.ball.style.left = "" + radius + "px";
	this.ball.style.top = "" + radius + "px";
	this.ball.style.borderRadius = "50%";
	document.body.appendChild(this.ball);
	var delegate = { left : radius, top : radius};
	var onChange = function() {
		_gthis.ball.style.left = delegate.left + "px";
		_gthis.ball.style.top = delegate.top + "px";
	};
	var tween4 = new com_gskinner_motion_GTween(delegate,0.4,{ top : 50},{ autoPlay : false, delay : 0.5, ease : com_gskinner_motion_easing_Sine.easeInOut, onChange : onChange});
	var tween3 = new com_gskinner_motion_GTween(delegate,0.4,{ left : 50},{ autoPlay : false, nextTween : tween4, delay : 0.5, ease : com_gskinner_motion_easing_Sine.easeInOut, onChange : onChange});
	var tween2 = new com_gskinner_motion_GTween(delegate,0.4,{ top : 350},{ autoPlay : false, nextTween : tween3, delay : 0.5, ease : com_gskinner_motion_easing_Sine.easeInOut, onChange : onChange});
	var tween1 = new com_gskinner_motion_GTween(delegate,0.5,{ left : 500},{ nextTween : tween2, delay : 0.5, ease : com_gskinner_motion_easing_Sine.easeInOut, onChange : onChange});
	tween4.nextTween = tween1;
};
GTweenSimpleSequencing.__name__ = true;
GTweenSimpleSequencing.main = function() {
...
com_gskinner_motion_easing_Sine.__name__ = true;
