...
var GTweenSpeedDemo = function() {
	...
	while(_g < 5000) {
		...
		var tween = new com_gskinner_motion_GTween(delegate,0.5,{ left : Math.random() * 600, top : Math.random() * 600},{ delay : Math.random(), onChange : $bind(this,this.onChange), onComplete : $bind(this,this.onComplete)});
	}
};
GTweenSpeedDemo.__name__ = true;
GTweenSpeedDemo.main = function() {
	new GTweenSpeedDemo();
};
GTweenSpeedDemo.prototype = {
	onChange: function(tween) {
